...
public class Config {
    ...
    public static final Object[] TITLES = new String[]{"DesignMyFeed"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://app.designmyfeed.com"};
    ...
    public static final String[] OPEN_OUTSIDE_WEBVIEW = new String[]{"market://","checkout.razorpay.com","razorpay.com","play.google.com", "plus.google.com", "mailto:", "tel:", "vid:", "geo:", "whatsapp:", "sms:", "intent://"};
    ...
    public static String[] PERMISSIONS_REQUIRED = new String[]{android.Manifest.permission.CAMERA,android.Manifest.permission.WRITE_EXTERNAL_STORAGE}; //Manifest.permission.PERMISSION_NAME
    ...
    public static String NO_CONNECTION_PAGE = ""; //file:///android_asset/index.html
